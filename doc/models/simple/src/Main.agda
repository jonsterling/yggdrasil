...
forest-▸ε-aux
  : {Γ : List Sig}{ψ₀* ψ₁* : List Tree}{τ* : List Tree}{X : Set}
  → Γ ⊩ ▸ε ψ₀* ∈ ψ₁* ⇉ τ*
  → (ψ₀* ≡ τ* → X)
  → X
forest-▸ε-aux (▸ε ω) κ = κ refl
...
module Test where
  ...
  test₃
    : Γ ⊢ ▸ψ (▸op "and") (▸φ (▸ψ (▸op "ff") (▸ε [])) (▸ε (▸ψ (▸op "bool") (▸ε []) ∷ [])))
        ∈ ▸ψ (▸op "bool") (▸ε []) ∷ []
        ⇒ ▸ψ (▸op "bool") (▸ε [])
  ...
  test₆
    : _≡_
       (tree-inf-inf Γ (▸ψ (▸op "and") (▸φ (▸ψ (▸op "ff") (▸ε [])) (▸ε (▸ψ (▸op "bool") (▸ε []) ∷ [])))))
       (⊕.inr
         ( ▸ψ (▸op "bool") (▸ε []) ∷ [] -- dom
         ▸ ▸ψ (▸op "bool") (▸ε [])      -- cod
         ▸ ▸ψ≡ "and" (▸φ (▸ψ≡ "ff" (▸ε [])) (▸ε (▸ψ (▸op "bool") (▸ε []) ∷ []))))
         )
  test₆ = refl
